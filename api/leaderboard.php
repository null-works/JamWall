...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $roundResults = [];
    $roundsStmt = $db->prepare('SELECT * FROM rounds WHERE voting_deadline < ? ORDER BY created_at DESC');
    $roundsStmt->bindValue(1, $now);
    $rounds = $roundsStmt->execute();
